module GamesLib
(CONF(EAST),CONF(WEST),Game(Game),Games,Team(Team),TeamScore(TeamScore),Standings,eliminationBruteForce,testTeamEliminationBruteForce,loadGames,cutofround,loadTeams,standing,gamesToPlay) where
